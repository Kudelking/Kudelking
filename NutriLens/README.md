...
> **Status:** M0–M3 · M5 nutrition DB · M6 vision · M7 photo analysis · M8 home + diary · M10 AI coach · M11 progress · M12 paywall · M9 sync · M13 notifications · M4 backend · M14 widgets/watch · settings · M15 l10n · app assembly (XcodeGen). See [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md)
