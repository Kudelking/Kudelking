...
export function QuoteForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    subject: "New Quote Request from Accent Walls Pro",
    firstName: "",
    lastName: "",
    email: "",
    phone: "",
    ...
    return (
      <div className="text-center py-8 animate-fade-in">
        ...
        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
          {result ||
            "Your quote request has been submitted successfully. We'll get back to you within 24 hours with a detailed estimate for your project."}
        </p>
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label
                    htmlFor="firstName"
                    className={cn(errors.firstName && touched.firstName ? "text-red-500" : "")}
                  >
